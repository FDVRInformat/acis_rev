package com.rouxy.phantom.helpers;
...
import com.rouxy.phantom.FakePlayerNameManager;

import com.rouxy.phantom.ai.AdventurerAI;
import com.rouxy.phantom.ai.ArchmageAI;
import com.rouxy.phantom.ai.CardinalAI;
import com.rouxy.phantom.ai.DominatorAI;
import com.rouxy.phantom.ai.DreadnoughtAI;
import com.rouxy.phantom.ai.DuelistAI;
import com.rouxy.phantom.ai.FakePlayerAI;
import com.rouxy.phantom.ai.FallbackAI;
import com.rouxy.phantom.ai.GhostHunterAI;
import com.rouxy.phantom.ai.GhostSentinelAI;
import com.rouxy.phantom.ai.GrandKhavatariAI;
import com.rouxy.phantom.ai.MoonlightSentinelAI;
import com.rouxy.phantom.ai.MysticMuseAI;
import com.rouxy.phantom.ai.SaggitariusAI;
import com.rouxy.phantom.ai.SoultakerAI;
import com.rouxy.phantom.ai.StormScreamerAI;
import com.rouxy.phantom.ai.TitanAI;
import com.rouxy.phantom.ai.WindRiderAI;
...
public class FakeHelpers {
	...
	public static FakePlayer createRandomFakePlayer() {
		...
		player.setTitle(Config.FAKE_PLAYER_TITLE);
		setLevel(player, 81);
		player.rewardSkills();
