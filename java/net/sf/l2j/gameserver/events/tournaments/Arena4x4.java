	...
	private class Pair
	{
		...
		public void rewards()
		{
			if ((leader != null) && (leader.isOnline()))
			{
				if (leader.isVip())
				{
					leader.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_WIN_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, leader, true);
				}
				else
				{
			...
			if ((assist != null) && (assist.isOnline()))
			{
				if (assist.isVip())
				{
					assist.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_WIN_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, assist, true);
				}
				else
				{
			...
			if ((assist2 != null) && (assist2.isOnline()))
			{
				if (assist2.isVip())
				{
					assist2.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_WIN_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, assist2, true);
				}
				else
				{
			...
			if ((assist3 != null) && (assist3.isOnline()))
			{
				if (assist3.isVip())
				{
					assist3.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_WIN_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, assist3, true);
				}
				else
				{
		...
		public void rewardsLost()
		{
			if ((leader != null) && (leader.isOnline()))
			{
				if (leader.isVip())
				{
					leader.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_LOST_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, leader, true);
				}
				else
			...
			if ((assist != null) && (assist.isOnline()))
			{
				if (assist.isVip())
				{
					assist.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_LOST_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, assist, true);
				}
				else
			...
			if ((assist2 != null) && (assist2.isOnline()))
			{
				if (assist2.isVip())
				{
					assist2.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_LOST_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, assist2, true);
				}
				else
			...
			if ((assist3 != null) && (assist3.isOnline()))
			{
				if (assist3.isVip())
				{
					assist3.addItem("Arena_Event", Config.ARENA_REWARD_ID, Config.ARENA_LOST_REWARD_COUNT_4X4 * Config.RATE_DROP_VIP, assist3, true);
				}
				else
	...
	private class EvtArenaTask implements Runnable
	{
		...
		private void rewardWinner()
		{
			if ((pairOne.isAlive()) && (!pairTwo.isAlive()))
			{
				...
				{
					Announcements.Announce("[4x4]: (" + leader1.getClan().getName() + " VS " + leader2.getClan().getName() + ") ~> " + leader1.getClan().getName() + " win!");
				}
				pairOne.rewards();
				pairTwo.rewardsLost();
			}
