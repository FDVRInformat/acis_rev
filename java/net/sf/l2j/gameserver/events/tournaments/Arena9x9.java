	...
	private class EvtArenaTask implements Runnable
	{
		...
		private void rewardWinner()
		{
			if ((pairOne.isAlive()) && (!pairTwo.isAlive()))
			{
				...
				{
					Announcements.Announce("[9x9]: (" + leader1.getClan().getName() + " VS " + leader2.getClan().getName() + ") ~> " + leader1.getClan().getName() + " win!");
				}
				pairOne.rewards();
				pairTwo.rewardsLost();
			}
