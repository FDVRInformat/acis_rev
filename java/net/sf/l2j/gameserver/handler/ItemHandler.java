...
import net.sf.l2j.gameserver.handler.itemhandlers.Habilitys;
import net.sf.l2j.gameserver.handler.itemhandlers.Harvester;
import net.sf.l2j.gameserver.handler.itemhandlers.ItemNobles;
...
public class ItemHandler
{
	...
	{
		registerItemHandler(new Habilitys());
